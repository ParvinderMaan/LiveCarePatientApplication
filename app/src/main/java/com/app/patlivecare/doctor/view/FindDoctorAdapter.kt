...
import kotlinx.android.synthetic.main.list_item_find_doctor.view.iv_doc_pic
...
class FindDoctorAdapter: PagedListAdapter<DoctorInfo,FindDoctorAdapter.DoctorViewHolder>(ITEM_COMPARATOR) {
