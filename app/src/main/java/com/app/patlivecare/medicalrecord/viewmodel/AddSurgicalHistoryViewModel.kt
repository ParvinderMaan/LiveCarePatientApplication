...
class AddSurgicalHistoryViewModel (application: Application) : AndroidViewModel(application) {
    ...
    fun addSurgicalHistory(inn: SurgicalHistoryInfo) {
        viewModelScope.launch {
            repository.addSurgicalHistory(headerMap,inn)
                .onStart {
