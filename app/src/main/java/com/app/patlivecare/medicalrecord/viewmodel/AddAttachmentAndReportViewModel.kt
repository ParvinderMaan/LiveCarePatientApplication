...
class AddAttachmentAndReportViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun addAttachmentHistory(reportName: RequestBody,
                             date: RequestBody,
                             desc: RequestBody,
                             documentFile: MultipartBody.Part) {
        viewModelScope.launch {
            repository.addAttachmentHistory(headerMap, reportName, date, desc, documentFile)
                .onStart {
