...
class AddAllergyHistoryViewModel  (application: Application) : AndroidViewModel(application) {
    ...
    fun addAllergyHistory(inn: AllergyHistoryInfo) {
        viewModelScope.launch {
            repository.addAllergyHistory(headerMap,inn)
                .onStart {
